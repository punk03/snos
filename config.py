...
PROMO_SYSTEM = {
    ...
    "disable_payment_system": False,  # Отключение системы оплаты подписки пользователями
    "promo_only_mode": False,  # Режим работы только через промокоды (без подписок)
    "reports_per_promo": {
        "default": 100,  # Количество сносов по умолчанию для промокода
        "min": 10,       # Минимальное количество сносов для промокода
        "max": 10000     # Максимальное количество сносов для промокода
    }
}
